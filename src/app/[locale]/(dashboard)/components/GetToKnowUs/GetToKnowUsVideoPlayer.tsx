    ...
    <>
      ...
      <button onClick={handlePlayVid}>
        <Image
          ...
          className="absolute top-[50%] left-[50%] w-[20%]  -translate-x-1/2 -translate-y-1/2 cursor-pointer z-30 "
        />
      </button>
      {isPlay ? (
        <iframe
          className={` z-40 w-[97%] h-[95%] rounded-[3rem] absolute top-4  right-5`}
