...
export default function ExploreCoursesLeftBtn() {
  ...
  return (
    <div
      className=" absolute top-1/2 -translate-y-1/2 left-6 z-40 hover:opacity-80 transition-all  w-[5.8rem] h-[5.8rem] flex justify-center items-center cursor-pointer"
