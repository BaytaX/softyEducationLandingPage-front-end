...
export default function BootcampsSwiperRightBtn() {
  ...
  return (
    <div
      className=" absolute hover:opacity-80 transition-all top-1/2 -translate-y-1/2 right-12 z-40   w-[5.8rem] h-[5.8rem] flex justify-center items-center cursor-pointer"
