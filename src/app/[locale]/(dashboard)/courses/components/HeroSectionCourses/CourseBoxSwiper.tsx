        ...
        <ArabicWrapper className="flex _2xl:flex-col">
          <div className="flex h-auto flex-col gap-4 w-7/12 shadow-[0_0_2rem_0.1rem_#b9b9b9] z-40 rounded-l-2xl _2xl:w-full  _2xl:shadow-[0_0_2rem_0.1rem_#b9b9b969] ">
            <div
              ...
              className={`bg-cover  h-[22rem] [border-top-left-radius:1rem] _2xl:h-[40rem] _2xl:rounded-t-[2rem]`}
            ></div>
            <div className="flex flex-col gap-6 h-[40%] p-6 bg-white [border-bottom-left-radius:1rem] _2xl:gap-10 _lg:!h-[60%]">
