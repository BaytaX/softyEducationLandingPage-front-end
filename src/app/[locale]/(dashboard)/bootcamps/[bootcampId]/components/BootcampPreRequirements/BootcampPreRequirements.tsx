...
export default function BootcampPreRequirements({
  ...
  return (
    <div className="mt-44 bg-bg-color-bootcamps-2 shadow-lg rounded-[2rem] w-[96%] flex justify-between items-center px-16 _1/2xl:pr-0">
      <div className="flex flex-col gap-6 py-16 _xl:gap-12">
        <h4 className="text-[2rem] font-medium _2xl:text-[2.6rem] _1/2xl:text-[3.2rem] _lg:!text-[4rem]">
          {t("title")}
        </h4>
        <p className="text-[1.7rem] text-gray-500 font-light _2xl:text-[2.2rem] _1/2xl:text-[2.4rem] _lg:!text-[3rem]">
          {t("subtitle")}
        </p>
