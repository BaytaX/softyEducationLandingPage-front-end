...
export default function ObjectivesBootcamp({ data }: any) {
  ...
  return (
    <div className="mt-44 flex flex-col gap-16">
      ...
      <div className=" bg-bg-color-bootcamps-2 shadow-lg rounded-[2rem] relative w-[98%] justify-between flex px-16 pb-12 _2xl:flex-col _2xl:!pr-0">
        <div className="flex flex-col gap-9 py-16 w-[80%] _2xl:w-11/12">
          <h4 className="text-[2rem] font-medium _2xl:text-[2.8rem] _1/2xl:text-[3.6rem] _lg:!text-[4.4rem]">
            {t("about")}
          </h4>
        ...
        <div className="relative w-[18%] _2xl:w-[25rem]   _2xl:h-[20rem] _2xl:self-end ">
          <Image
            src={PythonLogo}
            alt={"Python Logo"}
            width={60}
