...
export default function BootcampsCardReview() {
  ...
  return (
    <ArabicWrapper className="-ml-24 ">
      <div className="bg-color-blue-8 w-[96%]  mt-80  rounded-[2rem] shadow-xl pt-20 px-28 flex gap-4 pb-32 xl:-ml-12 xl:w-full lg:px-10 1/2xl:pt-44 2xl:flex-col ">
        <div className="w-7/12 2xl:w-11/12 lg:!w-full">
          <h2 className="text-[3.8rem] tracking-wide font-medium lg:text-[4.4rem]">
            {t("title")}
          </h2>
          <div className="mt-20 w-10/12 2xl:w-full lg:mt-44">
            <WhyChooseUsText
              title={t("whySoftylines_1")}
              us={true}
              titleClassName="text-[2rem] text-gray-1 -ml-2 2xl:text-[2.6rem] lg:!text-[3.6rem] "
        ...
        <div className="w-[44%] 2xl:w-2/3 self-center 1/2xl:w-[90%] md:!w-full">
