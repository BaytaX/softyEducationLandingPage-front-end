...
export default function ExploreCourseBox({ data }: any) {
  const { title, description, link } = data;
  return (
    <div className="	w-full h-[75rem] overflow-hidden">
      <div className=" p-10 gap-44 w-full h-full  flex flex-col justify-center items-center   bg-[linear-gradient(to_right_bottom,#00003099,#00003099),url('https://s3-alpha-sig.figma.com/img/c83f/0957/c8d81811e843b6070c5160b9521340d2?Expires=1708300800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=NaxWzcAqb~s479V-WnziRmRU7KwIJ5aY--DUCBF28xVvbrE67FIRn1dg5RBrOyb8E44EBa8KA~84XLSmUf1OoUZkZdcDOW~NdgcXC~3200TL5U1jYEdmVBTvFqXN9LytIpyB~T1TWJgZnPNJxOttMPj~36I3Lh2jC3fIYlPDrGcdeMhXJkrYWQFa9p0TCXajrBXs-NT7hTaMSdETT3Ssa~ujErySWcTvwyge2hj26gceUymsfFZ1XfOYl8Y3YGU1zVv683hT6pteZGictCyZh9pdm08zuoBBQlvtoxMjtfOtueb60tsLLXWZ-rFDToxQNq2vrlVtliDlW7c15VeDyw__')] bg-cover hover:scale-125 transition-all duration-300 	 ">
